...
VectorXd OrdinaryPoseController::getNewJointPositions(DQ reference, VectorXd thetas)
{
...
VectorXd OrdinaryPoseController::getNewJointVelocities(DQ reference, VectorXd thetas)
{
