...
/**
 * @brief Provides the kinematic model of the KUKA LWR4 robot manipulator.
 *
 * This class exposes a ready-to-use model of the KUKA LWR4 arm based on the
...
public:
    /**
     * @brief Returns the kinematic model of the KUKA LWR4 robot manipulator.
